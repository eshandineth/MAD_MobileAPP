            ...
            return isHorizontal
                ? Row(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 3,
                        child: _productDetails(args, isDarkMode),
                      ),
                    ],
                  )
                : Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text('Color:', style: const TextStyle(fontSize: 14)),
          DropdownButton<String>(
            value: _selectedColor,
            hint: const Text('Choose Color', style: TextStyle(fontSize: 14)),
          ...
          ElevatedButton(
            onPressed: () {
              print(
                  'Adding to cart: ${args['productName']}, Color: $_selectedColor, Quantity: $_quantity');
            },
